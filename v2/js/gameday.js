...
window.CR.runJulieAssist = () => {
  if (window.CR.currentGameDayMode === 'missing' || window.CR.currentGameDayMode === 'pregame') {
    ...
    custom.heroEventTitle = 'Home took the lead';
    custom.heroEventMeta = 'Jarvis answer goal · rivalry flips';
    custom.heroPhase = '2ND PERIOD 7:42';
